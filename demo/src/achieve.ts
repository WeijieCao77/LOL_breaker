...
import { S } from "./state";
import { addTrustAll, salaryOf } from "./team";
...
export const ACH_REWARD_TXT={fat:"体力",money:"奖金",trust:"士气",fame:"名气"};
...
/* ---------- 引擎 ---------- */
export function initAch(){ S.ach={}; S.achLog=[]; }
export function hasAch(id){ return !!(S.ach&&S.ach[id]); }
...
/* 解锁之后再查一遍「解锁 N 项」这类成就（原来是在文件末尾把 checkAch 整个换掉；ES 模块里不能给函数声明赋值） */
