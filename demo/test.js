...
try {
  new Function(code + "\n;globalThis.__api={S:()=>S,SEASONS,SPLITS,DIMS,AGES,BACKGROUNDS,ACHIEVEMENTS,RANKS,"
    ...
    + "askTransfer,canAskTransfer,askTransferOdds,checkStreamBiz,streamDealCard,streamPushMul,signStreamDeal,declineStreamDeal,fireWeekEvents,clubPlatform,streamClauseCheck,worldsSlot,spectateIntl,startIntl,startPlayoff,endSeason,"
